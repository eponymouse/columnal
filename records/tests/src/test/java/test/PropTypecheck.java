...
public class PropTypecheck
{
    ...
    // @SuppressWarnings("nullness")
    public void propTypeCheckSucceed(@When(seed=1L) @From(GenExpressionValueBackwards.class) @From(GenExpressionValueForwards.class) ExpressionValue src) throws InternalException, UserException
    {
