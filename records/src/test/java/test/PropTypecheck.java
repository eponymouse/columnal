...
public class PropTypecheck
{
    ...
    public void propTypeCheckFail(@When(seed=-4969683091882907444L) @From(GenTypecheckFail.class) GenTypecheckFail.TypecheckInfo src) throws InternalException, UserException
    {
