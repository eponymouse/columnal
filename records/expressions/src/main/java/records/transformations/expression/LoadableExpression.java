...
public interface LoadableExpression<EXPRESSION extends LoadableExpression<EXPRESSION, SEMANTIC_PARENT> & StyledShowable, SEMANTIC_PARENT> extends StyledShowable
{
    ...
    public static interface SingleLoader<EXPRESSION extends LoadableExpression<EXPRESSION, SEMANTIC_PARENT> & StyledShowable, SEMANTIC_PARENT, R>
    {
        ...
        @OnThread(Tag.FXPlatform)
        public static <EXPRESSION extends LoadableExpression<EXPRESSION, SEMANTIC_PARENT> & StyledShowable, SEMANTIC_PARENT> Consecutive.ConsecutiveStartContent<EXPRESSION, SEMANTIC_PARENT>
